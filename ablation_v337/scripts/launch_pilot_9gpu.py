#!/usr/bin/env python3
"""
Launch LatBOND v3.3.7 Expanded Pilot: 9 jobs on 9 GPUs.
3 architectures x 3 conditions @ 40ms budget.

Each job trains ONE model, allowing full parallelization.
v3.3.7: ~150s/epoch (was ~9,000s in v3.3.5). Total time: ~2 hours.
